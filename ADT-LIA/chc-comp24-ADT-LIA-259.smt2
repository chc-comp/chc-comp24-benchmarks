...
(assert
  (forall ( (A list_89) (B Int) (C list_89) (D list_89) (E Int) (F list_89) (G Int) ) 
    (=>
      (and
        (take_18 D G F)
        (and (= B (+ 1 G)) (= C (cons_89 E D)) (= A (cons_89 E F)) (not (= (- 1) G)))
      )
      (take_18 C B A)
    )
  )
...
(assert
  (forall ( (A list_89) (B Int) (C list_89) (D Int) (E list_89) (F Int) ) 
    (=>
      (and
        (drop_20 C F E)
        (and (not (= F (- 1))) (= A (cons_89 D E)) (= B (+ 1 F)))
      )
      (drop_20 C B A)
    )
  )
