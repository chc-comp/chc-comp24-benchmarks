...
(assert
  (forall ( (A pair_12) (B pair_12) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (and (= A (pair_13 E F)) (= B (pair_13 C D)) (not (= C E)))
      )
      (diseqpair_6 B A)
    )
  )
...
(assert
  (forall ( (A pair_12) (B pair_12) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (and (= A (pair_13 E F)) (= B (pair_13 C D)) (not (= D F)))
      )
      (diseqpair_6 B A)
    )
  )
...
(assert
  (forall ( (A list_33) (B list_33) (C list_34) (D list_34) (E Int) (F list_33) (G Int) (H list_33) ) 
    (=>
      (and
        (zip_6 D H F)
        (and (= B (cons_33 G H)) (= C (cons_34 (pair_13 G E) D)) (= A (cons_33 E F)))
      )
      (zip_6 C B A)
    )
  )
