  ...
  (forall ( (A list_325) (B list_326) (C Int) (D list_326) (E Int) (F list_325) (G Int) ) 
    (=>
      (and
        (add_426 C G E)
        (petersen_12 D G F)
        (and (= B (cons_322 (pair_129 E C) D)) (= A (cons_321 E F)))
      )
      (petersen_12 B G A)
    )
  )
  ...
  (forall ( (A Int) (B list_325) (C list_326) (D Int) (E list_326) (F Int) (G list_325) ) 
    (=>
      (and
        (add_426 D A F)
        (petersen_13 E G)
        (and (= B (cons_321 F G)) (= C (cons_322 (pair_129 F D) E)) (= A 1))
      )
      (petersen_13 C B)
    )
  )
    ...
    (=>
      (and
        ...
        (let ((a!1 (cons_323 (cons_322 (pair_129 F G) (cons_322 (pair_129 C D) nil_367))
                     E)))
  (and (= B a!1) (= A (cons_322 (pair_129 F G) H))))
      )
      (petersen_14 B I A)
    )
  )
...
(assert
  (forall ( (A list_325) (B Maybe_10) (C Int) (D list_325) (v_4 Int) ) 
    (=>
      (and
        (and (= B (Just_10 C)) (= A (cons_321 C D)) (= 0 v_4))
      )
      (index_2 B A v_4)
    )
  )
  ...
  (forall ( (A Int) (B list_325) (C Int) (D Maybe_10) (E Int) (F list_325) (G Int) ) 
    (=>
      (and
        (minus_421 C G A)
        (index_2 D F C)
        (and (not (= G 0)) (= B (cons_321 E F)) (= A 1))
      )
      (index_2 D B G)
    )
  )
  ...
  (forall ( (A Int) (B list_325) (C list_324) (D list_324) (E Int) (F list_325) ) 
    (=>
      (and
        (formula_6 D F)
        (lt_420 E A)
        (and (= C (cons_320 true_400 D)) (= B (cons_321 E F)) (= A 3))
      )
      (formula_6 C B)
    )
  )
  ...
  (forall ( (A Int) (B list_325) (C list_324) (D list_324) (E Int) (F list_325) ) 
    (=>
      (and
        (formula_6 D F)
        (ge_400 E A)
        (and (= C (cons_320 false_400 D)) (= B (cons_321 E F)) (= A 3))
      )
      (formula_6 C B)
    )
  )
