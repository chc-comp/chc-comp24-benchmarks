  ...
  (forall ( (A list_1) (B list_0) (C list_0) (D Bool_0) (E list_1) (F Nat_0) (v_6 Bool_0) ) 
    (=>
      (and
        (models_1 C F E)
        (diseqBool_0 D v_6)
        (and (= v_6 true_0) (= A (cons_1 (pair_1 F D) E)) (= B (cons_0 true_0 C)))
      )
      (models_1 B F A)
    )
  )
  ...
  (forall ( (A list_1) (B list_0) (C list_0) (D Nat_0) (E Bool_0) (F list_1) (G Nat_0) (v_7 Bool_0) ) 
    (=>
      (and
        ...
        (diseqNat_0 G D)
        (diseqBool_0 E v_7)
        (and (= v_7 true_0) (= A (cons_1 (pair_1 D E) F)) (= B (cons_0 false_0 C)))
      )
      (models_1 B G A)
    )
  )
...
(assert
  (forall ( (A list_1) (B list_0) (C list_0) (D list_1) (E Nat_0) ) 
    (=>
      (and
        (models_2 C E D)
        (and (= A (cons_1 (pair_1 E true_0) D)) (= B (cons_0 true_0 C)))
      )
      (models_2 B E A)
    )
  )
  ...
  (forall ( (A list_1) (B list_0) (C list_0) (D Nat_0) (E list_1) (F Nat_0) ) 
    (=>
      (and
        (models_2 C F E)
        (diseqNat_0 F D)
        (and (= A (cons_1 (pair_1 D true_0) E)) (= B (cons_0 false_0 C)))
      )
      (models_2 B F A)
    )
  )
