  ...
  (forall ( (A list_1) (B list_2) (C Nat_0) (D Nat_0) (E Nat_0) (F Nat_0) (G Nat_0) (H list_2) (I Nat_0) (J list_1) (K Nat_0) (v_11 Nat_0) (v_12 Nat_0) ) 
    (=>
      (and
        ...
        (add_0 E K v_12)
        (add_0 F E K)
        (and (= v_11 K) (= v_12 K) (= B (cons_2 (pair_1 D G) H)) (= A (cons_1 I J)))
      )
      (dodeca_1 B K A)
    )
  )
  ...
  (forall ( (A list_1) (B list_2) (C Nat_0) (D Nat_0) (E Nat_0) (F list_2) (G Nat_0) (H list_1) (I Nat_0) (v_9 Nat_0) ) 
    (=>
      (and
        ...
        (add_0 C I G)
        (add_0 D I v_9)
        (and (= v_9 I) (= B (cons_2 (pair_1 C E) F)) (= A (cons_1 G H)))
      )
      (dodeca_3 B I A)
    )
  )
  ...
  (forall ( (A list_1) (B list_2) (C Nat_0) (D list_2) (E Nat_0) (F list_1) (G Nat_0) ) 
    (=>
      (and
        (add_0 C G E)
        (dodeca_4 D G F)
        (and (= B (cons_2 (pair_1 E C) D)) (= A (cons_1 E F)))
      )
      (dodeca_4 B G A)
    )
  )
  ...
  (forall ( (A list_1) (B list_2) (C Nat_0) (D list_2) (E Nat_0) (F list_1) (v_6 Nat_0) ) 
    (=>
      (and
        (add_0 C v_6 E)
        (dodeca_5 D F)
        (and (= v_6 (Z_15 Z_14)) (= B (cons_2 (pair_1 E C) D)) (= A (cons_1 E F)))
      )
      (dodeca_5 B A)
    )
  )
