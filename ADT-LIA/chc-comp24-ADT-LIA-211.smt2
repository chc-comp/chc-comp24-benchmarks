  ...
  (forall ( (A ~Mut<~Mut<~Mut<Int>>>) (B ~Mut<~Mut<~Mut<Int>>>) (C Bool) (D Bool) (E Int) (F Int) (G Int) (H ~Mut<Int>) (I ~Mut<~Mut<Int>>) (J ~Mut<~Mut<Int>>) (K Int) (L ~Mut<Int>) (M ~Mut<~Mut<Int>>) (N ~Mut<~Mut<Int>>) ) 
    (=>
      (and
        (%main.3 G K E C D)
        (%swap2_dec B A)
        (let ((a!1 (= B (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> E G) H) J)))
      (a!2 (= A (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> F K) L) N))))
  (and (= M N)
       (= I J)
    ...
    (=>
      ...
      (a!2 (= F
              (~mut<~Mut<~Mut<Int>>>
                ...
                (~ret<~Mut<~Mut<Int>>> G)))))
  (and (= B (~mut<~Mut<Int>> (~cur<~Mut<Int>> J) L))
       (= C (~mut<~Mut<~Mut<Int>>> (~cur<~Mut<~Mut<Int>>> H) K))
       (= D (~mut<~Mut<~Mut<Int>>> (~cur<~Mut<~Mut<Int>>> G) J))
       a!1
       a!2
...
(assert
  (forall ( (A ~Mut<~Mut<~Mut<Int>>>) (B ~Mut<~Mut<~Mut<Int>>>) (C ~Mut<~Mut<~Mut<Int>>>) (D ~Mut<~Mut<~Mut<Int>>>) (E ~Mut<~Mut<Int>>) (F ~Mut<~Mut<Int>>) (v_6 Bool) ) 
    (=>
      (and
        (%swap2_dec B A)
        (let ((a!1 (+ (- 1) (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> C)))))
      (a!4 (+ (- 2) (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> D))))))
(let ((a!2 (~mut<Int> a!1
                      (~ret<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> C)))))
      (a!5 (~mut<Int> a!4
                      (~ret<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> D))))))
(let ((a!3 (~mut<~Mut<~Mut<Int>>>
             (~mut<~Mut<Int>> a!2 (~ret<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> C)))
             E))
      (a!6 (~mut<~Mut<~Mut<Int>>>
             (~mut<~Mut<Int>> a!5 (~ret<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> D)))
             F)))
  (and (= (~ret<~Mut<~Mut<Int>>> D) F)
       (= B a!3)
       (= A a!6)
       (= (~ret<~Mut<~Mut<Int>>> C) E)
       (= v_6 false)))))
