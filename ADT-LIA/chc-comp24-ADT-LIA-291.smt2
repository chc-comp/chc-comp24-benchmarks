...
(assert
  (forall ( (A list_106) (B list_106) (C list_106) (D Int) (E Bool_142) (F list_106) (G Int) ) 
    (=>
      (and
        (models_0 C G F)
        (and (= A (cons_106 (pair_35 D E) F))
     (= B (cons_106 (pair_35 D E) C))
     (not (= G D)))
      )
      (models_0 B G A)
    )
...
(assert
  (forall ( (A list_106) (B list_105) (C list_105) (D list_106) (E Int) ) 
    (=>
      (and
        (models_1 C E D)
        (and (= A (cons_106 (pair_35 E false_142) D)) (= B (cons_105 true_142 C)))
      )
      (models_1 B E A)
    )
  )
...
(assert
  (forall ( (A list_106) (B list_105) (C list_105) (D list_106) (E Int) ) 
    (=>
      (and
        (models_2 C E D)
        (and (= A (cons_106 (pair_35 E true_142) D)) (= B (cons_105 true_142 C)))
      )
      (models_2 B E A)
    )
  )
...
(assert
  ...
  (and (= v_6 false_142) (= A (Var_0 E)) a!1))
      )
      (models_3 B A F)
    )
  )
...
(assert
  ...
  (and (= v_6 false_142) (= A (Not_142 (Var_0 E))) a!1))
      )
      (models_3 B A F)
    )
  )
...
(assert
  (forall ( (A Form_0) (B list_107) (C list_106) (D list_107) (E Form_0) (v_5 list_106) (v_6 Bool_142) ) 
    (=>
      (and
        (models_3 B A v_5)
        (and (= v_5 nil_117) (= A (Not_142 E)) (= B (cons_107 C D)) (= v_6 false_142))
      )
      (valid_0 v_6 E)
    )
  )
