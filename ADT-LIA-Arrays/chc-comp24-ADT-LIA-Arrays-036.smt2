...
(declare-fun |inv_main84| ( Heap Int Int Int Int Int Int ) Bool)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Heap) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Heap) (v_13 Int) (v_14 Int) ) 
    (=>
      (and
        (inv_main60 M L K J I H G)
        (let ((a!1 (ite (and (not (<= G 0)) (>= (HeapSize M) G))
                (select (HeapContents M) G)
                defObj)))
(let ((a!2 (O_node (node G (data (getnode a!1))))))
